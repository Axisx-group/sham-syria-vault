    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {pages.reduce((total, page) => total + parseInt(page.views.replace(',', '')), 0).toLocaleString()}
            </div>
            <p className="text-xs text-muted-foreground">
              +8% من الشهر الماضي
            </p>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {Math.round(pages.reduce((total, page) => total + page.seoScore, 0) / pages.length)}%
            </div>
            <p className="text-xs text-muted-foreground">
              جيد جداً
            </p>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {pages.filter(page => page.mobileOptimized).length}/{pages.length}
            </div>
            <p className="text-xs text-muted-foreground">
              صفحة محسنة
            </p>
              ...
              {editingInline === page.id ? (
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex gap-2">
                      <Button size="sm" onClick={() => handleSaveInlineEdit(page.id)}>
                        <Save className="h-4 w-4 mr-2" />
                        حفظ
                      </Button>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <Select 
                          ...
                          onValueChange={(value) => handleInputChange(page.id, 'status', value)}
                        >
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
                      ...
                      <div className="space-y-2">
                        {(editedPages[page.id]?.content?.sections || page.content.sections).map((section: string, index: number) => (
                          <div key={index}>
                            <Input 
                              value={section}
                              onChange={(e) => handleSectionChange(page.id, index, e.target.value)}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
                  ...
                  <div className="lg:col-span-2">
                    <div className="flex gap-2">
                      ...
                      <Button size="sm" variant="outline" onClick={() => handleInlineEdit(page.id)}>
